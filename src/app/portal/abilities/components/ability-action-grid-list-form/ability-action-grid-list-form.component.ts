...
import { AbilityActionGridListFormItemComponent } from '../ability-action-grid-list-form-item/ability-action-grid-list-form-item.component'

@Component({
  selector: 'gow-ability-action-grid-list-form',
  templateUrl: './ability-action-grid-list-form.component.html',
  imports: [
    AbilityActionFormDialogComponent,
    AbilityActionGridListFormItemComponent,
    ButtonModule,
    LucideAngularModule
  ]
})
export class AbilityActionGridListFormComponent {
